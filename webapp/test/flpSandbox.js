		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#altrotestaltrotest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"altrotestaltrotest-display": {
								"semanticObject": "altrotestaltrotest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=altrotest.altrotest",
									"url": sap.ui.require.toUrl("altrotest/altrotest")
								}
							}
						}
					}
